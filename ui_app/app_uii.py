...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/images/aboutIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout.setIcon(icon5)
        self.actionAbout_Qt = QAction(MainWindow)
        self.actionAbout_Qt.setObjectName(u"actionAbout_Qt")
        icon6 = QIcon()
        icon6.addFile(u":/images/aboutQtIcon.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout_Qt.setIcon(icon6)
        self.actionRedo = QAction(MainWindow)
        self.actionRedo.setObjectName(u"actionRedo")
        icon7 = QIcon()
        icon7.addFile(u":/images/redoIcon.png", QSize(), QIcon.Normal, QIcon.Off)
